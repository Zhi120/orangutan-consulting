...
```
By refitting the model using the Bayesian Approach(stan_glmer), we get similar MSE result with glmmTMB, confirming that model 3 is the best model.
...
**Age6(-0.1974)**: Holding all other variables constant, compared with age group 1, the mean diversity score of age group 6 is expected to decrease by 0.1974.

**Age7(-0.2507)**: Holding all other variables constant, compared with age group 1, the mean diversity score of age group 7 is expected to decrease by 0.2507.

**SexM(-0.3857)**: Holding all other variables constant, compared with female orangutans, the mean diversity score of male orangutans is expected to decrease by 0.3857.

**Minutes Awake(0.0002346)**: Holding all other variables constant, one more minutes awake for orangutan, its diversity score is expected to increase by 0.0002346.
...
**Age7:SexM(0.6123)**: Holding all other variables constant, for age group 7, the mean diversity score is expected to have an additional increase of 0.6123 for male orangutan group compared with female orangutan group. In other words, in age group 7, the difference of mean diversity score between male and female group is further reduced by 0.6123.
