...
# Part 1: The Distribution of Minutes Awake
```{r, echo=FALSE}
>>>>>>> 1c13f5020921ff195337bba3d19d49c24d9f3636
...
ggplot(average_minutes_awake, aes(x = factor(Age, labels = age_ranges), y = avg_minutes_awake)) +
  ...
  theme( ) 
```
The average minutes awake is relatively consistent across all age groups, hovering around 630–660 minutes.
...
```
The model will fail to converge for glmer for both model.2 and model.3.
Based on the model output result, model.3 is the best model, and minutes awake is a statistically significant variable.
...
>>>>>>> d44ae0f6a94409208e26ae694a3afd0f300db234
...
# Conclusion
In conclusion, we check the assumption of clients' model and optimize the model based on our exploration of data. Firstly we add sex and minutes awake into the independent variables. 
