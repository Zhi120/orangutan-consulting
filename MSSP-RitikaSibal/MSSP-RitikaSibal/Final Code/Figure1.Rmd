...
knitr::opts_chunk$set(echo = TRUE, warning = FALSE, comment = "##", prompt = TRUE, tidy = TRUE, tidy.opts = list(width.cutoff = 75), fig.path = "/Users/ritikasibal/Desktop/W24/Research/OntogenyOfLocomotion/Final Code/Figure1 Images/")
```
...
load_in_data_pre <- function(){
    d <- read_xlsx("~/Desktop/Knott-Lab-Research/OntogenyOfLocomotion/Ritika Excel Files/Locomotion Export 15 Feb 2024.xlsx",sheet = 1, guess_max = 1048576)
