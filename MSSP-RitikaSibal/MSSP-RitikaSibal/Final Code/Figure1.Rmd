...
## Calculate Diversity
```{r}
df_score <- read.csv("C:/Users/Owner/Documents/orangutan-consulting fork/diversity_score.csv")
df <- read.csv("C:/Users/Owner/Documents/orangutan-consulting fork/final_data.csv")
```

```{r}
hist(df_score$DiversityScore, main = "Histogram of DiversityScore", xlab = "DiversityScore")
qqnorm(df_score$DiversityScore)
qqline(df_score$DiversityScore, col = "red")
