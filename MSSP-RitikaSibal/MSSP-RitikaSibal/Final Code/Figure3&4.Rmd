...
knitr::opts_chunk$set(echo = TRUE, warning = FALSE, comment = "##", prompt = TRUE, tidy = TRUE, tidy.opts = list(width.cutoff = 75), fig.path = "/Users/ritikasibal/Desktop/W24/Research/OntogenyOfLocomotion/Final Code/Figure3&4 Images/")
```
...
d_juv <- load_in_data_post("~/Desktop/Knott-Lab-Research/OntogenyOfLocomotion/Ritika Excel Files/parsed-all.xlsx", adult=FALSE)

d_adult <- load_in_data_post("~/Desktop/Knott-Lab-Research/OntogenyOfLocomotion/Ritika Excel Files/parsed-mother-infant.xlsx", adult=TRUE)
...
dict <- read_xlsx("~/Desktop/Knott-Lab-Research/OntogenyOfLocomotion/Ritika Excel Files/IndividualSex.xlsx" ,sheet = 1, guess_max = 1048576)
...
=======
>>>>>>> ae58cbdaf00133d4390d1cb861cfb5d7b8bca63e
```
